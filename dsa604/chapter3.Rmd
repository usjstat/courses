...
This plot shows:
- The **prior** (yellow)
- The **likelihood**, scaled to have area 1 (blue)
- The **posterior** (green), a compromise between prior and likelihood
...
```{r}
# Simulate polling outcomes Y for each pi
...
```{r}
# Keep only simulated pi values where Y = 30
...
```{r}
# Plot the density of posterior pi values
