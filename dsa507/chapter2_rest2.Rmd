...
The **binomial distribution** models the number of successes in a fixed number of independent trials, where each trial has only two outcomes: **success** or **failure**. Each trial has the same probability of success, denoted by \( \pi \), and the number of trials is denoted by \( n \).
...
- Mean: \( n \times \pi \)  
- Variance: \( n \times \pi \times (1 - \pi) \)  

As \( n \) becomes large and \( \pi \) is not too close to 0 or 1, the binomial distribution approximates the normal distribution.
