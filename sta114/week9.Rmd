...
Let \( X \) be a random variable (discrete or continuous). The **cumulative distribution function (cdf)** of \( X \) is defined as:
...
\begin{cases}
0 & \text{if } x < 0 \\
\int_0^x 2t\,dt = x^2 & \text{if } 0 \leq x \leq 1 \\
1 & \text{if } x > 1
\end{cases}
\]
