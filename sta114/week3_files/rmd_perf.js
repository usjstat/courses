...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 80 }, { marker: 'pandoc', elapsed: 200 }, { marker: 'post-processor', elapsed: 20 }, { marker: 'pre-processor', elapsed: 0 }, { marker: 'render', elapsed: 680 } ];
